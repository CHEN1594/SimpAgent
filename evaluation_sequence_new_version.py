...
processor = AutoProcessor.from_pretrained("/data/models/Qwen2-VL-2B-Instruct")
...
aitw_imgs_dir = "/data/zhouxurui/GUI-dataset/aitw_seeclick/aitw_images"
aitw_test = json.load(open('/data/zhouxurui/GUI-dataset/aitw_seeclick/aitw_data_test.json', 'r'))
